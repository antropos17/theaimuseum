  ...
  return (
    ...
    >
      ...
      >
        {/* Error header bar */}
        <div
          className="flex items-center gap-3 border-b border-dashed border-border/30 px-4 py-2.5"
        ...
        <div className="px-4 py-4">
          ...
          <div className="mt-3 flex items-start gap-2">
            ...
            <p className="text-[13px] leading-relaxed text-orange-300/90">{item.cause}</p>
          </div>
        ...
        >
          <div
            className="border-t border-dashed border-border/30 px-4 py-4"
          ...
          >
            <div className="flex gap-2">
              ...
              <div>
                ...
                <p className="text-[13px] leading-relaxed text-foreground/70">{item.detail}</p>
              </div>
            </div>
            <div className="mt-4 flex items-center gap-3 border-t border-dashed border-border/20 pt-3">
              ...
              <span className="font-mono text-[10px] text-red-400">PERMANENTLY_OFFLINE</span>
      ...
      <div className="mx-auto max-w-3xl px-4 pb-24 pt-10">
        ...
        >
          ...
          <p className="mt-2 max-w-md text-[14px] leading-relaxed text-muted-foreground">
            Fatal errors. Catastrophic failures. Cautionary tales from the history of artificial
            intelligence.
          </p>
        ...
        >
          <div className="border-t border-dashed border-border/20 pt-8 text-center">
            ...
            <p className="mt-4 font-mono text-[10px] text-red-400/30">{'> process.exit(1)_'}</p>
          </div>
        </div>
      </div>
    </div>
