...
const wings = [
  {
    icon: Compass,
    name: 'Timeline',
    desc: `All ${models.length} AI models mapped chronologically across 75 years of history`,
    tag: `${models.length} models`,
    href: '/explore',
    featured: true,
  },
  {
    icon: Terminal,
    name: 'Simulator',
    desc: `Chat with artificial intelligence across ${simulatorEras.length} distinct eras, from ELIZA to GPT-5`,
  ...
  },
  {
    icon: BrainCircuit,
    name: 'Quiz',
    desc: `Test your AI IQ with ${quizQuestions.length} questions`,
