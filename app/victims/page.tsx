...
export const metadata: Metadata = {
  ...
  description: "Which professions is AI disrupting? Data-driven analysis of automation rates across 20+ industries — from creative and technical to service and knowledge work.",
  openGraph: {
    title: "AI Job Displacement Tracker | The AI Museum",
    description: "Which professions is AI disrupting? Automation risk data across 20+ industries.",
    images: [{ url: "/api/og?title=AI%20Job%20Displacement%20Tracker&subtitle=The%20Human%20Cost%20of%20Progress", width: 1200, height: 630 }],
  },
  twitter: {
